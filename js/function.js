...
$(document).ready(function() {
    ...
    $('.colorCorrection__colorsToggle').on('click', function() {
        $('.colorCorrection__item').addClass('shuffled');
        let id = $(this).data('show');
        $('.colorCorrection__colorsToggle').removeClass('active');
        $('.colorCorrection__item').removeClass('active');
        $(this).addClass('active');
        $('#'+id).appendTo('.colorCorrection__slider');
        if ($('#'+id).last) {
            console.log('last');
            $('#'+id).addClass('active').insertAfter('.colorCorrection__item:nth-of-type(2)');
        } else {
        }
        setTimeout(function () {
            $('.colorCorrection__item').removeClass('shuffled');
        }, 1000);
    });
